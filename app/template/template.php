        ...
        <section class="section order">
            <div class="container">
                ...
                <div class="order__form">
                    <form class="order__form-tag" action = 'order/add' id="order-form">
                            ...
                            <div class="order__form-buttons">
                                <div class="order__form-row">
                                    <label class="order__radio">
                                        <input class="order__radio-elem" value="1" name="payment" type="radio">
                                        <div class="order__radio-fake"></div>
                                        <div class="order__radio-title">Потребуется сдача</div>
                                    </label>
                                    <label class="order__radio">
                                        <input class="order__radio-elem" value="0" name="payment" type="radio">
                                        <div class="order__radio-fake"></div>
                                ...
                                <div class="order__form-row">
                                    <label class="order__radio order__radio_checkbox">
                                        <input class="order__radio-elem" value="1" name="callback" type="checkbox">
                                        <div class="order__radio-fake"></div>
            ...
            <div class="order__modal js-show-order">
                <div class="order__block">
                    <div class="order__info-block">
                        <button class="close order__close js-order-close"></button>
                        <div class="order__info-title js-put-order-name">

                        </div>
                        <div class="order__info-text js-put-order-text">
